...
public class CompatBlockCrop extends BlockCrops
{
	...
	protected Item getSeed()
	{
		...
		else
		{
			...
			this.name == "block_crop_certus_quartz" ? ItemMod.seed_crop_certus_quartz :
			this.name == "block_crop_crystal_flux" ? ItemMod.seed_crop_crystal_flux :
			this.name == "block_crop_pure_fluix" ? ItemMod.seed_crop_pure_fluix :null;
		}
	}
	...
	protected Item getCrop()
	{
		...
		else
		{
			...
			this.name == "block_crop_certus_quartz" ? ItemMod.fruit_certus_quartz :  
		    this.name == "block_crop_crystal_flux" ? ItemMod.fruit_crystal_flux :    
	        this.name == "block_crop_pure_fluix" ? ItemMod.fruit_pure_fluix : null;  
		}
	}
}
