...
public class FireDim {
	...
	static {
		portal = (BlockfirePortal) (new BlockfirePortal().func_149663_c("firedim_portal"));
		block = (fireTrigger) (new fireTrigger().func_77655_b("firedim_trigger"));
	}
	...
	public void load(FMLInitializationEvent event) {
		...
		if (event.getSide() == Side.CLIENT)
			Minecraft.func_71410_x().func_175599_af().func_175037_a()
					.func_178086_a(block, 0, new ModelResourceLocation(Reference.MOD_ID + ":firedim_trigger", "inventory"));
					...
					for (int i1 = -2; i1 <= 2; ++i1) {
						for (int j1 = -1; j1 < 3; ++j1) {
							...
							this.worldServerInstance.func_175656_a(new BlockPos(k1, l1, i2),
									flag ? BlockMod.fire_block.func_176223_P() : Blocks.field_150350_a.func_176223_P());
						}
					}
				}
				...
				for (k3 = 0; k3 < 4; ++k3) {
					for (l3 = -1; l3 < 4; ++l3) {
						...
						this.worldServerInstance
								.func_180501_a(new BlockPos(i4, j4, k4), flag1 ? BlockMod.fire_block.func_176223_P() : iblockstate, 2);
					}
				}
	...
	public static class BlockfirePortal extends Block {
		...
		public boolean tryToCreatePortal(World par1World, int par2, int par3, int par4) {
			byte b0 = 0;
			byte b1 = 0;
			if (getBlock(par1World, par2 - 1, par3, par4) == BlockMod.fire_block || getBlock(par1World, par2 + 1, par3, par4) == BlockMod.fire_block) {
				b0 = 1;
			}
			if (getBlock(par1World, par2, par3, par4 - 1) == BlockMod.fire_block || getBlock(par1World, par2, par3, par4 + 1) == BlockMod.fire_block) {
				b1 = 1;
			}
			if (b0 == b1) {
				return false;
		...
		public void func_189540_a(IBlockState state, World par1World, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (getBlock(par1World, par2, i1 - 1, par4) != BlockMod.fire_block) {
				...
				if (j1 == 3 && getBlock(par1World, par2, i1 + j1, par4) == BlockMod.fire_block) {
					...
					if (flag && flag1) {
						...
						if ((getBlock(par1World, par2 + b0, par3, par4 + b1) != BlockMod.fire_block || getBlock(par1World, par2 - b0, par3, par4 - b1) != this)
								&& (getBlock(par1World, par2 - b0, par3, par4 - b1) != BlockMod.fire_block || getBlock(par1World, par2 + b0, par3, par4
										+ b1) != this)) {
							par1World.func_175698_g(new BlockPos(par2, par3, par4));
						}
					}
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		protected static final IBlockState field_185982_a = Blocks.field_189877_df.func_176223_P();
		...
		private IBlockState oceanBlock = Blocks.field_150353_l.func_176223_P();
		...
		protected static final IBlockState GRAVEL = Blocks.field_150353_l.func_176223_P();
		private final WorldGenerator quartzGen = new WorldGenMinable(BlockMod.magma_fire_ore.func_176223_P(), 7, BlockMatcher.func_177642_a(Blocks.field_189877_df));
