...
public class FireDim {
					...
					for (int i1 = -2; i1 <= 2; ++i1) {
						for (int j1 = -1; j1 < 3; ++j1) {
							...
							this.worldServerInstance.setBlockState(new BlockPos(k1, l1, i2),
									flag ? BlockMod.fire_block.getDefaultState() : Blocks.AIR.getDefaultState());
						}
					}
				}
				...
				for (k3 = 0; k3 < 4; ++k3) {
					for (l3 = -1; l3 < 4; ++l3) {
						...
						this.worldServerInstance
								.setBlockState(new BlockPos(i4, j4, k4), flag1 ? BlockMod.fire_block.getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		...
		private final WorldGenerator quartzGen = new WorldGenMinable(BlockMod.magma_fire_ore.getDefaultState(), 7, BlockMatcher.forBlock(Blocks.MAGMA));
