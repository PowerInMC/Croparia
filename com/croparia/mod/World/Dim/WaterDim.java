...
public class WaterDim {
	...
	public static class BlockWaterPortal extends Block {
		...
		public boolean tryToCreatePortal(World par1World, int par2, int par3, int par4) {
			byte b0 = 0;
			byte b1 = 0;
			if (getBlock(par1World, par2 - 1, par3, par4) == BlockMod.water_block || getBlock(par1World, par2 + 1, par3, par4) == BlockMod.water_block) {
				b0 = 1;
			}
			if (getBlock(par1World, par2, par3, par4 - 1) == BlockMod.water_block || getBlock(par1World, par2, par3, par4 + 1) == BlockMod.water_block) {
				b1 = 1;
			}
			if (b0 == b1) {
				return false;
		...
		public void func_189540_a(IBlockState state, World par1World, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (getBlock(par1World, par2, i1 - 1, par4) != BlockMod.water_block) {
				...
				if (j1 == 3 && getBlock(par1World, par2, i1 + j1, par4) == BlockMod.water_block) {
