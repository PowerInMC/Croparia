...
public class AirDim {
					...
					for (int i1 = -2; i1 <= 2; ++i1) {
						for (int j1 = -1; j1 < 3; ++j1) {
							...
							this.worldServerInstance.setBlockState(new BlockPos(k1, l1, i2),
									flag ? BlockMod.air_block.getDefaultState() : Blocks.AIR.getDefaultState());
						}
					}
				}
				...
				for (k3 = 0; k3 < 4; ++k3) {
					for (l3 = -1; l3 < 4; ++l3) {
						...
						this.worldServerInstance
								.setBlockState(new BlockPos(i4, j4, k4), flag1 ? BlockMod.air_block.getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		...
		private IBlockState oceanBlock = BlockMod.cloud.getDefaultState();
		...
		protected static final IBlockState GRAVEL = BlockMod.cloud.getDefaultState();
		private final WorldGenerator quartzGen = new WorldGenMinable(BlockMod.cloud_air_ore.getDefaultState(), 7, BlockMatcher.forBlock(BlockMod.cloud));
		private final WorldGenerator quartzblockGen = new WorldGenMinable(Blocks.QUARTZ_BLOCK.getDefaultState(), 14, BlockMatcher.forBlock(BlockMod.cloud));
		...
		public void populate(int x, int z) {
			...
			if (net.minecraftforge.event.terraingen.TerrainGen.generateOre(this.world, this.rand, quartzblockGen, blockpos,
						net.minecraftforge.event.terraingen.OreGenEvent.GenerateMinable.EventType.QUARTZ))
					for (int l1 = 0; l1 < 16; ++l1) {
						this.quartzblockGen.generate(this.world, this.rand,
								blockpos.add(this.rand.nextInt(16), this.rand.nextInt(108) + 10, this.rand.nextInt(16)));
					}	
