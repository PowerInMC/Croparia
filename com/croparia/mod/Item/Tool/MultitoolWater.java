...
public class MultitoolWater extends ItemMultitool 
{

	public MultitoolWater(float damage, float speed, ToolMaterial material)
	{
	...
	public EnumActionResult func_180614_a(EntityPlayer stack, World playerIn, BlockPos worldIn, EnumHand pos, EnumFacing hand, float facing, float hitX, float hitY) 
	{
		...
		if(stack.func_70093_af() == true)
		{
	        ...
	        else
	        {
	            ...
	            {
	            	if(playerIn.func_180495_p(worldIn.func_177984_a()).func_177230_c() == Blocks.field_150355_j || playerIn.func_180495_p(worldIn.func_177984_a()).func_177230_c() == Blocks.field_150350_a)
	            	{
	            		if (block == Blocks.field_150458_ak || block == Blocks.field_150349_c || block == Blocks.field_150348_b || block == Blocks.field_150346_d || block == Blocks.field_150354_m  || block == Blocks.field_150351_n || block == Blocks.field_150322_A || block == Blocks.field_150405_ch )
	            		{
