...
public class TileEntityObsidianFurnace extends TileEntityLockable implements ITickable, ISidedInventory 
{
	...
	{
		return ((func_145818_k_()) ? this.furnaceCustomName : "container.obsidian_furnace");
	}
	...
	public void func_73660_a() {
		...
		if (!(this.field_145850_b.field_72995_K)) 
		{
			...
			{
				flag1 = true;
				BlockObsidianFurnace.setState(isBurning(), this.field_145850_b, this.field_174879_c);
			}
		}
