...
public class CaneCobble extends BlockReed
{
	...
	public Block onIt = Blocks.field_150347_e;
	...
	{
		return Item.func_150898_a(BlockMod.block_cane_cobble);
	}
	
	@Override
	public ItemStack func_185473_a(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(Item.func_150898_a(BlockMod.block_cane_cobble));
	}
