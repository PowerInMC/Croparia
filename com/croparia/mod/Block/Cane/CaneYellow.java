...
public class CaneYellow extends BlockReed
{

	public Block onIt = Blocks.CONCRETE;
	
	public CaneYellow(String name) 
	{
		super();
	...
	{
		return Item.getItemFromBlock(BlockMod.block_cane_yellow);
	}
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(Item.getItemFromBlock(BlockMod.block_cane_yellow));
	}
