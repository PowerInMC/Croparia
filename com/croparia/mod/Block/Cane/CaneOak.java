...
public class CaneOak extends BlockReed
{
	int a = 0;
	int b = a+4;
	int c = b+4;
	...
	{
		return Item.func_150898_a(BlockMod.block_cane_oak);
	}
	
	@Override
	public ItemStack func_185473_a(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(Item.func_150898_a(BlockMod.block_cane_oak));
	}
