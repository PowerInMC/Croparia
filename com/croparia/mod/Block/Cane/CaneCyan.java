...
public class CaneCyan extends BlockReed
{

	public Block onIt = Blocks.CONCRETE;
	
	public CaneCyan(String name) 
	{
		super();
	...
	{
		return Item.getItemFromBlock(BlockMod.block_cane_cyan);
	}
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(Item.getItemFromBlock(BlockMod.block_cane_cyan));
	}
