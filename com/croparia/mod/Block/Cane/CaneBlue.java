...
public class CaneBlue extends BlockReed
{

	public Block onIt = Blocks.CONCRETE;
	
	public CaneBlue(String name) 
	{
		super();
	...
	{
		return Item.getItemFromBlock(BlockMod.block_cane_blue);
	}
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(Item.getItemFromBlock(BlockMod.block_cane_blue));
	}
