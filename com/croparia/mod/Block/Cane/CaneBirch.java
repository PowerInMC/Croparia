...
public class CaneBirch extends BlockReed
{
	...
	{
		return Item.getItemFromBlock(BlockMod.block_cane_birch);
	}
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(Item.getItemFromBlock(BlockMod.block_cane_birch));
	}
	...
	public boolean canPlaceBlockAt(World worldIn, BlockPos pos)
    {
        ...
        else if (state != onIt.getStateFromMeta(2))
        {
            return false;
        }
        else
