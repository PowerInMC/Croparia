...
public class CaneOrange extends BlockReed
{

	public Block onIt = Blocks.CONCRETE;
	
	public CaneOrange(String name) 
	{
		super();
	...
	{
		return Item.getItemFromBlock(BlockMod.block_cane_orange);
	}
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(Item.getItemFromBlock(BlockMod.block_cane_orange));
	}
