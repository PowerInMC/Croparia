...
public class CaneGrass extends BlockReed
{

	public Block onIt = Blocks.field_150349_c;
	
	public CaneGrass(String name) 
	{
		super();
		func_149663_c(name);
	...
	{
		return Item.func_150898_a(BlockMod.block_cane_grass);
	}
	
	@Override
	public ItemStack func_185473_a(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(Item.func_150898_a(BlockMod.block_cane_grass));
	}
