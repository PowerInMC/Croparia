...
public class CaneGrass extends BlockReed
{
	...
	public Block onIt = Blocks.GRASS;
	...
	{
		return Item.getItemFromBlock(BlockMod.block_cane_grass);
	}
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(Item.getItemFromBlock(BlockMod.block_cane_grass));
	}
