...
public class CaneMagenta extends BlockReed
{

	public Block onIt = Blocks.CONCRETE;
	
	public CaneMagenta(String name) 
	{
		super();
	...
	{
		return Item.getItemFromBlock(BlockMod.block_cane_magenta);
	}
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(Item.getItemFromBlock(BlockMod.block_cane_magenta));
	}
