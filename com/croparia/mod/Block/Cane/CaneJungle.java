...
public class CaneJungle extends BlockReed
{
	int a = 3;
	int b = a+4;
	int c = b+4;
	...
	{
		return Item.func_150898_a(BlockMod.block_cane_jungle);
	}
	
	@Override
	public ItemStack func_185473_a(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(Item.func_150898_a(BlockMod.block_cane_jungle));
	}
	...
	public boolean func_176196_c(World worldIn, BlockPos pos)
    {
        ...
        else if (state != onIt.func_176203_a(3))
        {
            return false;
        }
        else
