...
public class CaneSpruce extends BlockReed
{
	int a = 1;
	int b = a+4;
	int c = b+4;
	...
	public Block onIt = Blocks.field_150364_r;
	
	public CaneSpruce(String name) 
	{
		super();
		func_149663_c(name);
	...
	{
		return Item.func_150898_a(BlockMod.block_cane_spruce);
	}
	
	@Override
	public ItemStack func_185473_a(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(Item.func_150898_a(BlockMod.block_cane_spruce));
	}
