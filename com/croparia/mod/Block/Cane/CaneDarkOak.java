...
public class CaneDarkOak extends BlockReed
{
	int a = 1;
	int b = a+4;
	int c = b+4;
	...
	public Block onIt = Blocks.field_150363_s;
	
	public CaneDarkOak(String name) 
	{
		super();
		func_149663_c(name);
	...
	{
		return Item.func_150898_a(BlockMod.block_cane_darkoak);
	}
	
	@Override
	public ItemStack func_185473_a(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(Item.func_150898_a(BlockMod.block_cane_darkoak));
	}
	...
	public boolean func_176196_c(World worldIn, BlockPos pos)
    {
        ...
        else if (state != onIt.func_176203_a(1))
        {
            return false;
        }
        else
