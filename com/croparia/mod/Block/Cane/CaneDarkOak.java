...
public class CaneDarkOak extends BlockReed
{
	...
	{
		return Item.getItemFromBlock(BlockMod.block_cane_darkoak);
	}
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(Item.getItemFromBlock(BlockMod.block_cane_darkoak));
	}
	...
	public boolean canPlaceBlockAt(World worldIn, BlockPos pos)
    {
        ...
        else if (state != onIt.getStateFromMeta(1))
        {
            return false;
        }
        else
