...
public class CaneRed extends BlockReed
{

	public Block onIt = Blocks.CONCRETE;
	
	public CaneRed(String name) 
	{
		super();
	...
	{
		return Item.getItemFromBlock(BlockMod.block_cane_red);
	}
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(Item.getItemFromBlock(BlockMod.block_cane_red));
	}
