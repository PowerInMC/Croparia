...
public class BlockRedstoneFurnace extends BlockContainer {
	...
	public Item func_180660_a(IBlockState state, Random rand, int fortune) {
		return Item.func_150898_a(BlockMod.redstone_furnace);
	}
	...
	public boolean func_180639_a(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (tileentity instanceof TileEntityRedstoneFurnace) {
			playerIn.func_71007_a((TileEntityRedstoneFurnace) tileentity);
	...
	public static void setState(boolean active, World worldIn, BlockPos pos) {
		...
		if (active) {
			worldIn.func_180501_a(pos,
					BlockMod.lit_redstone_furnace.func_176223_P().func_177226_a(FACING, iblockstate.func_177229_b(FACING)), 3);
			worldIn.func_180501_a(pos,
					BlockMod.lit_redstone_furnace.func_176223_P().func_177226_a(FACING, iblockstate.func_177229_b(FACING)), 3);
		} else {
			worldIn.func_180501_a(pos,
					BlockMod.redstone_furnace.func_176223_P().func_177226_a(FACING, iblockstate.func_177229_b(FACING)), 3);
			worldIn.func_180501_a(pos,
					BlockMod.redstone_furnace.func_176223_P().func_177226_a(FACING, iblockstate.func_177229_b(FACING)), 3);
		}
	...
	public void func_180633_a(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer,
		...
		if (!(tileentity instanceof TileEntityRedstoneFurnace))
			return;
		((TileEntityRedstoneFurnace) tileentity).setCustomInventoryName(stack.func_82833_r());
	}
	...
	public void func_180663_b(World worldIn, BlockPos pos, IBlockState state) {
		if (!(keepInventory)) {
			...
			if (tileentity instanceof TileEntityRedstoneFurnace) {
				InventoryHelper.func_180175_a(worldIn, pos, (TileEntityRedstoneFurnace) tileentity);
