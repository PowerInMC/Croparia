...
public class ItemMod
{
    ...
    public static void init(){
    	...
    	seed_crop_certus_quartz = new ItemSeedsModCompat(BlockMod.block_crop_certus_quartz, Blocks.FARMLAND, "seed_crop_certus_quartz");
    	seed_crop_crystal_flux = new ItemSeedsModCompat(BlockMod.block_crop_crystal_flux, Blocks.FARMLAND, "seed_crop_crystal_flux");
    	seed_crop_pure_fluix = new ItemSeedsModCompat(BlockMod.block_crop_pure_fluix, Blocks.FARMLAND, "seed_crop_pure_fluix");
    	...
    	certus_quartz = new Item().setRegistryName("certus_quartz").setUnlocalizedName("certus_quartz");
    	crystal_flux = new Item().setRegistryName("crystal_flux").setUnlocalizedName("crystal_flux");
    	pure_fluix = new Item().setRegistryName("pure_fluix").setUnlocalizedName("pure_fluix");
