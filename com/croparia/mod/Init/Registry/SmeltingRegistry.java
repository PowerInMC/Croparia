...
public class SmeltingRegistry 
{
	...
	{
		GameRegistry.addSmelting(Items.field_151117_aB, new ItemStack(ItemMod.cheese), 0.5F);
		...
		GameRegistry.addSmelting(ItemMod.flour, new ItemStack(Items.field_151025_P), 1.0F);	
