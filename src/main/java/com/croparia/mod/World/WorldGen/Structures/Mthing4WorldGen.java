package com.croparia.mod.World.WorldGen.Structures;
...
public class Mthing4WorldGen extends WorldGenerator {
	...
	public boolean generate(World world, Random rand, BlockPos position) {
		...
		Template template = templatemanager.getTemplate(minecraftserver, new ResourceLocation(Reference.MOD_ID+":minotaur_thing4"));
			...
			template.addBlocksToWorld(world, position.add(0, 1, 0), placementsettings);
	         ...
	         for (Entry<BlockPos, String> entry : map.entrySet())
	         {
	             if ("chest".equals(entry.getValue()))
	             {
	                 ...
	                 world.setBlockState(blockpos2, Blocks.CHEST.getDefaultState(), 3);
