...
public class CanePink extends BlockReed
{

	public Block onIt = Blocks.CONCRETE;
	
	public CanePink(String name) 
	{
		super();
	...
	{
		return Item.getItemFromBlock(BlockMod.block_cane_pink);
	}
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(Item.getItemFromBlock(BlockMod.block_cane_pink));
	}
