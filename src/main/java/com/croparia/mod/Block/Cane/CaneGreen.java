...
public class CaneGreen extends BlockReed
{

	public Block onIt = Blocks.CONCRETE;
	
	public CaneGreen(String name) 
	{
		super();
	...
	{
		return Item.getItemFromBlock(BlockMod.block_cane_green);
	}
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(Item.getItemFromBlock(BlockMod.block_cane_green));
	}
