...
public class CaneCobble extends BlockReed
{

	public Block onIt = Blocks.COBBLESTONE;
	
	public CaneCobble(String name) 
	{
		super();
	...
	{
		return Item.getItemFromBlock(BlockMod.block_cane_cobble);
	}
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(Item.getItemFromBlock(BlockMod.block_cane_cobble));
	}
