...
public class CaneWhite extends BlockReed
{

	public Block onIt = Blocks.CONCRETE;
	
	public CaneWhite(String name) 
	{
		super();
	...
	{
		return Item.getItemFromBlock(BlockMod.block_cane_white);
	}
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(Item.getItemFromBlock(BlockMod.block_cane_white));
	}
