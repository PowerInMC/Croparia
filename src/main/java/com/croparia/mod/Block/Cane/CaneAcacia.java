...
public class CaneAcacia extends BlockReed
{
	...
	{
		return Item.getItemFromBlock(BlockMod.block_cane_acacia);
	}
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(Item.getItemFromBlock(BlockMod.block_cane_acacia));
	}
	...
	public boolean canPlaceBlockAt(World worldIn, BlockPos pos)
    {
        ...
        else if (state != onIt.getStateFromMeta(0))
        {
            return false;
        }
        else
