...
public class CaneLime extends BlockReed
{

	public Block onIt = Blocks.CONCRETE;
	
	public CaneLime(String name) 
	{
		super();
	...
	{
		return Item.getItemFromBlock(BlockMod.block_cane_lime);
	}
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(Item.getItemFromBlock(BlockMod.block_cane_lime));
	}
