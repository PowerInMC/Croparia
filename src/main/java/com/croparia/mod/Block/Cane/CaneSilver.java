...
public class CaneSilver extends BlockReed
{

	public Block onIt = Blocks.CONCRETE;
	
	public CaneSilver(String name) 
	{
		super();
	...
	{
		return Item.getItemFromBlock(BlockMod.block_cane_silver);
	}
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(Item.getItemFromBlock(BlockMod.block_cane_silver));
	}
