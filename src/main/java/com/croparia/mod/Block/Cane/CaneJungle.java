...
public class CaneJungle extends BlockReed
{
	...
	{
		return Item.getItemFromBlock(BlockMod.block_cane_jungle);
	}
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(Item.getItemFromBlock(BlockMod.block_cane_jungle));
	}
	...
	public boolean canPlaceBlockAt(World worldIn, BlockPos pos)
    {
        ...
        else if (state != onIt.getStateFromMeta(3))
        {
            return false;
        }
        else
