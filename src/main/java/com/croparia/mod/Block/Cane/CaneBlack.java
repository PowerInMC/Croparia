...
public class CaneBlack extends BlockReed
{

	public Block onIt = Blocks.CONCRETE;
	
	public CaneBlack(String name) 
	{
		super();
	...
	{
		return Item.getItemFromBlock(BlockMod.block_cane_black);
	}
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(Item.getItemFromBlock(BlockMod.block_cane_black));
	}
