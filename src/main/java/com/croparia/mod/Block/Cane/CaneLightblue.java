...
public class CaneLightblue extends BlockReed
{

	public Block onIt = Blocks.CONCRETE;
	
	public CaneLightblue(String name) 
	{
		super();
	...
	{
		return Item.getItemFromBlock(BlockMod.block_cane_lightblue);
	}
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(Item.getItemFromBlock(BlockMod.block_cane_lightblue));
	}
