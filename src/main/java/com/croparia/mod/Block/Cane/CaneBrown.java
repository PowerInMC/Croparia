...
public class CaneBrown extends BlockReed
{

	public Block onIt = Blocks.CONCRETE;
	
	public CaneBrown(String name) 
	{
		super();
	...
	{
		return Item.getItemFromBlock(BlockMod.block_cane_brown);
	}
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(Item.getItemFromBlock(BlockMod.block_cane_brown));
	}
