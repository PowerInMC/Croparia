...
public class BlockObsidianGround extends BlockBush 
{
    ...
    public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entityIn)
    {
    	if(entityIn instanceof EntityPlayer)
    	{
    		...
    		if(player.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem() != ItemMod.elemental_fire_boots && this.name == "obsidian_ground")
    		{
    		...
    		else if(this.name == "obsidian_fired_ground")
    		{
    			if(player.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem() != ItemMod.elemental_fire_boots)
        		{
    				((EntityLivingBase) entityIn).addPotionEffect(new PotionEffect(MobEffects.SLOWNESS, 400, 0));
    				((EntityLivingBase) entityIn).addPotionEffect(new PotionEffect(MobEffects.WEAKNESS, 400, 0));
        		}
    ...
    {
        return state.getBlock() == Blocks.MAGMA || state.getBlock() == BlockMod.magma_fire_ore;
    }
