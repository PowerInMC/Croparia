...
public class BlockRitualGhost extends Block{
			...
			EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) 
	{
		...
		{	
			...
			if(i == 4)
				Minecraft.getMinecraft().player.sendChatMessage("Stone Ritual");
		}
		return true;
	}
   ...
   @Override
	...
	public void onEntityWalk(World worldIn, BlockPos pos, Entity entityIn)
		...
		IBlockState urne = BlockMod.ghost_empty_urne.getDefaultState();
			...
			if(i == 4 && entityIn instanceof EntityPlayer && worldIn.isRemote)
			{
				if(worldIn.getBlockState(pos.west(7)) != BlockMod.empty_urne.getDefaultState())
				    worldIn.setBlockState(pos.west(7), urne);
				if(worldIn.getBlockState(pos.north(7)) != BlockMod.empty_urne.getDefaultState())
				    worldIn.setBlockState(pos.north(7), urne);
				if(worldIn.getBlockState(pos.south(7)) != BlockMod.empty_urne.getDefaultState())
				    worldIn.setBlockState(pos.south(7), urne);
				if(worldIn.getBlockState(pos.east(7)) != BlockMod.empty_urne.getDefaultState())
				    worldIn.setBlockState(pos.east(7), urne);
				if(worldIn.getBlockState(pos.north(5).east(5)) != BlockMod.empty_urne.getDefaultState())
				    worldIn.setBlockState(pos.north(5).east(5), urne);
				if(worldIn.getBlockState(pos.south(5).east(5)) != BlockMod.empty_urne.getDefaultState())
				    worldIn.setBlockState(pos.south(5).east(5), urne);
				if(worldIn.getBlockState(pos.north(5).west(5)) != BlockMod.empty_urne.getDefaultState())
				    worldIn.setBlockState(pos.north(5).west(5), urne);
				if(worldIn.getBlockState(pos.south(5).west(5)) != BlockMod.empty_urne.getDefaultState())
				    worldIn.setBlockState(pos.south(5).west(5), urne);
				for(int v = 0; v < 5; v++)
				{
					if(worldIn.getBlockState(pos.north(7).west(3).up(v)) != Blocks.STONE.getStateFromMeta(5))
					    worldIn.setBlockState(pos.north(7).west(3).up(v), polished_andesite);
					if(worldIn.getBlockState(pos.north(7).east(3).up(v)) != Blocks.STONE.getStateFromMeta(5))
					    worldIn.setBlockState(pos.north(7).east(3).up(v), polished_andesite);
	
					if(worldIn.getBlockState(pos.south(7).west(3).up(v)) != Blocks.STONE.getStateFromMeta(5))
					    worldIn.setBlockState(pos.south(7).west(3).up(v), polished_andesite);
					if(worldIn.getBlockState(pos.south(7).east(3).up(v)) != Blocks.STONE.getStateFromMeta(5))
					    worldIn.setBlockState(pos.south(7).east(3).up(v), polished_andesite);
	
					if(worldIn.getBlockState(pos.west(7).south(3).up(v)) != Blocks.STONE.getStateFromMeta(5))
					    worldIn.setBlockState(pos.west(7).south(3).up(v), polished_andesite);
					if(worldIn.getBlockState(pos.west(7).north(3).up(v)) != Blocks.STONE.getStateFromMeta(5))
					    worldIn.setBlockState(pos.west(7).north(3).up(v), polished_andesite);
	
					if(worldIn.getBlockState(pos.east(7).south(3).up(v)) != Blocks.STONE.getStateFromMeta(5))
					    worldIn.setBlockState(pos.east(7).south(3).up(v), polished_andesite);
					if(worldIn.getBlockState(pos.east(7).north(3).up(v)) != Blocks.STONE.getStateFromMeta(5))
					    worldIn.setBlockState(pos.east(7).north(3).up(v), polished_andesite);
				}
				for(int v = -3; v < 4; v++)
				{
					if(worldIn.getBlockState(pos.north(7).east(v).up(4)) != Blocks.STONE.getStateFromMeta(5))
					    worldIn.setBlockState(pos.north(7).east(v).up(4), polished_andesite);
					if(worldIn.getBlockState(pos.south(7).east(v).up(4)) != Blocks.STONE.getStateFromMeta(5))
					    worldIn.setBlockState(pos.south(7).east(v).up(4), polished_andesite);
					if(worldIn.getBlockState(pos.east(7).north(v).up(4)) != Blocks.STONE.getStateFromMeta(5))
					    worldIn.setBlockState(pos.east(7).north(v).up(4), polished_andesite);
					if(worldIn.getBlockState(pos.west(7).north(v).up(4)) != Blocks.STONE.getStateFromMeta(5))
					    worldIn.setBlockState(pos.west(7).north(v).up(4), polished_andesite);
				}
				if(worldIn.getBlockState(pos.north(7).east(4).up(4)) != Blocks.STONE.getStateFromMeta(5))
				    worldIn.setBlockState(pos.north(7).east(4).up(4), polished_andesite);
				if(worldIn.getBlockState(pos.north(6).east(4).up(4)) != Blocks.STONE.getStateFromMeta(5))
				    worldIn.setBlockState(pos.north(6).east(4).up(4), polished_andesite);
				if(worldIn.getBlockState(pos.north(6).east(5).up(4)) != Blocks.STONE.getStateFromMeta(5))
					worldIn.setBlockState(pos.north(6).east(5).up(4), polished_andesite);
				if(worldIn.getBlockState(pos.north(5).east(5).up(4)) != Blocks.STONE.getStateFromMeta(5))
					worldIn.setBlockState(pos.north(5).east(5).up(4), polished_andesite);
				if(worldIn.getBlockState(pos.north(5).east(6).up(4)) != Blocks.STONE.getStateFromMeta(5))
					worldIn.setBlockState(pos.north(5).east(6).up(4), polished_andesite);
				if(worldIn.getBlockState(pos.north(4).east(6).up(4)) != Blocks.STONE.getStateFromMeta(5))
					worldIn.setBlockState(pos.north(4).east(6).up(4), polished_andesite);
				if(worldIn.getBlockState(pos.north(4).east(7).up(4)) != Blocks.STONE.getStateFromMeta(5))
					worldIn.setBlockState(pos.north(4).east(7).up(4), polished_andesite);
				

				if(worldIn.getBlockState(pos.north(7).west(4).up(4)) != Blocks.STONE.getStateFromMeta(5))
				    worldIn.setBlockState(pos.north(7).west(4).up(4), polished_andesite);
				if(worldIn.getBlockState(pos.north(6).west(4).up(4)) != Blocks.STONE.getStateFromMeta(5))
				    worldIn.setBlockState(pos.north(6).west(4).up(4), polished_andesite);
				if(worldIn.getBlockState(pos.north(6).west(5).up(4)) != Blocks.STONE.getStateFromMeta(5))
					worldIn.setBlockState(pos.north(6).west(5).up(4), polished_andesite);
				if(worldIn.getBlockState(pos.north(5).west(5).up(4)) != Blocks.STONE.getStateFromMeta(5))
					worldIn.setBlockState(pos.north(5).west(5).up(4), polished_andesite);
				if(worldIn.getBlockState(pos.north(5).west(6).up(4)) != Blocks.STONE.getStateFromMeta(5))
					worldIn.setBlockState(pos.north(5).west(6).up(4), polished_andesite);
				if(worldIn.getBlockState(pos.north(4).west(6).up(4)) != Blocks.STONE.getStateFromMeta(5))
					worldIn.setBlockState(pos.north(4).west(6).up(4), polished_andesite);
				if(worldIn.getBlockState(pos.north(4).west(7).up(4)) != Blocks.STONE.getStateFromMeta(5))
					worldIn.setBlockState(pos.north(4).west(7).up(4), polished_andesite);
				

				if(worldIn.getBlockState(pos.south(7).east(4).up(4)) != Blocks.STONE.getStateFromMeta(5))
				    worldIn.setBlockState(pos.south(7).east(4).up(4), polished_andesite);
				if(worldIn.getBlockState(pos.south(6).east(4).up(4)) != Blocks.STONE.getStateFromMeta(5))
				    worldIn.setBlockState(pos.south(6).east(4).up(4), polished_andesite);
				if(worldIn.getBlockState(pos.south(6).east(5).up(4)) != Blocks.STONE.getStateFromMeta(5))
					worldIn.setBlockState(pos.south(6).east(5).up(4), polished_andesite);
				if(worldIn.getBlockState(pos.south(5).east(5).up(4)) != Blocks.STONE.getStateFromMeta(5))
					worldIn.setBlockState(pos.south(5).east(5).up(4), polished_andesite);
				if(worldIn.getBlockState(pos.south(5).east(6).up(4)) != Blocks.STONE.getStateFromMeta(5))
					worldIn.setBlockState(pos.south(5).east(6).up(4), polished_andesite);
				if(worldIn.getBlockState(pos.south(4).east(6).up(4)) != Blocks.STONE.getStateFromMeta(5))
					worldIn.setBlockState(pos.south(4).east(6).up(4), polished_andesite);
				if(worldIn.getBlockState(pos.south(4).east(7).up(4)) != Blocks.STONE.getStateFromMeta(5))
					worldIn.setBlockState(pos.south(4).east(7).up(4), polished_andesite);
				

				if(worldIn.getBlockState(pos.south(7).west(4).up(4)) != Blocks.STONE.getStateFromMeta(5))
				    worldIn.setBlockState(pos.south(7).west(4).up(4), polished_andesite);
				if(worldIn.getBlockState(pos.south(6).west(4).up(4)) != Blocks.STONE.getStateFromMeta(5))
				    worldIn.setBlockState(pos.south(6).west(4).up(4), polished_andesite);
				if(worldIn.getBlockState(pos.south(6).west(5).up(4)) != Blocks.STONE.getStateFromMeta(5))
					worldIn.setBlockState(pos.south(6).west(5).up(4), polished_andesite);
				if(worldIn.getBlockState(pos.south(5).west(5).up(4)) != Blocks.STONE.getStateFromMeta(5))
					worldIn.setBlockState(pos.south(5).west(5).up(4), polished_andesite);
				if(worldIn.getBlockState(pos.south(5).west(6).up(4)) != Blocks.STONE.getStateFromMeta(5))
					worldIn.setBlockState(pos.south(5).west(6).up(4), polished_andesite);
				if(worldIn.getBlockState(pos.south(4).west(6).up(4)) != Blocks.STONE.getStateFromMeta(5))
					worldIn.setBlockState(pos.south(4).west(6).up(4), polished_andesite);
				if(worldIn.getBlockState(pos.south(4).west(7).up(4)) != Blocks.STONE.getStateFromMeta(5))
					worldIn.setBlockState(pos.south(4).west(7).up(4), polished_andesite);
				

				if(worldIn.getBlockState(pos.down()) != BlockMod.elemental_stone.getDefaultState())
					worldIn.setBlockState(pos.down(), elementalstone);
				}
	}
}
