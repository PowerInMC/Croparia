...
public class BlockElementalStone extends Block {
	...
	{		
			//Stone ritual
			if(!worldIn.isRemote)
			if(worldIn.getBlockState(pos.north(7).west(3).up(0)) == Blocks.STONE.getStateFromMeta(6) && worldIn.getBlockState(pos.north(7).east(3).up(0)) == Blocks.STONE.getStateFromMeta(6) && worldIn.getBlockState(pos.south(7).west(3).up(0)) == Blocks.STONE.getStateFromMeta(6) && worldIn.getBlockState(pos.south(7).east(3).up(0)) == Blocks.STONE.getStateFromMeta(6) && (worldIn.getBlockState(pos.west(7).south(3).up(0)) == Blocks.STONE.getStateFromMeta(6) && worldIn.getBlockState(pos.west(7).north(3).up(0)) == Blocks.STONE.getStateFromMeta(6) && worldIn.getBlockState(pos.east(7).south(3).up(0)) == Blocks.STONE.getStateFromMeta(6) && worldIn.getBlockState(pos.east(7).north(3).up(0)) == Blocks.STONE.getStateFromMeta(6)))
