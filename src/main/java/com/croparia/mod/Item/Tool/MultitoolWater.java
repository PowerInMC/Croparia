	...
	public EnumActionResult onItemUse(EntityPlayer stack, World playerIn, BlockPos worldIn, EnumHand pos, EnumFacing hand, float facing, float hitX, float hitY) 
	{
		...
		if(stack.isSneaking() == true)
		{
	        ...
	        else
	        {
	            ...
	            {
	            	if(playerIn.getBlockState(worldIn.up()).getBlock() == Blocks.WATER || playerIn.getBlockState(worldIn.up()).getBlock() == Blocks.AIR)
	            	{
	            		if (block == Blocks.FARMLAND || block == Blocks.GRASS || block == Blocks.STONE || block == Blocks.DIRT || block == Blocks.SAND  || block == Blocks.GRAVEL || block == Blocks.SANDSTONE || block == Blocks.HARDENED_CLAY )
	            		{
