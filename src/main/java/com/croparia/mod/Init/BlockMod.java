...
import com.croparia.mod.Block.Spawn.BlockWaterbossSpawn;
...
public class BlockMod {
	...
	private static CreativeTabs wip = CreativeTabsRegistry.WIP;
		...
		public static Block ghost_empty_urne;
		...
		public static Block block_crop_osmium;
		...
		public static Block filled_urne_s;
		public static Block filled_urne_m;
		public static Block filled_urne_c;
		public static Block filled_urne_f;
		...
		public static void init() {
			...
			ghost_empty_urne = new BlockGhost("ghost_empty_urne");
			

			empty_urne = new BlockUrne("empty_urne", true, false, false, false, false, false);
			empty_urne_raw = new BlockUrne("empty_urne_raw", false, false, false, false, false, true);
			filled_urne_s = new BlockUrne("filled_urne_s", false, true, false, false, false, false);
			filled_urne_m = new BlockUrne("filled_urne_m", false, false, true, false, false, false);
			filled_urne_c = new BlockUrne("filled_urne_c", false, false, false, true, false, false);
			filled_urne_f = new BlockUrne("filled_urne_f", false, false, false, false, true, false);
			
			
			reward = new CropPulsor("reward");
			...
			block_crop_osmium = new CompatBlockCrop("block_crop_osmium");
		...
		public static void register() {	
			...
			if(ModLoader.getTechReborn || ModLoader.getThermalFoundation || ModLoader.getForestry || ModLoader.getIC2 || ModLoader.getMekanism)
	    	{
			...
			if(ModLoader.getTechReborn || ModLoader.getThermalFoundation || ModLoader.getImmersive || ModLoader.getForestry || ModLoader.getIC2 || ModLoader.getMekanism)
	    	{
			...
			if(ModLoader.getTechReborn || ModLoader.getThermalFoundation || ModLoader.getImmersive || ModLoader.getIC2)
	    	{
				add(block_crop_lead);
	    	}
		...
		public static void registerRenders() {
			...
			registerRender(filled_urne_s);
			registerRender(filled_urne_m);
			registerRender(filled_urne_c);
			registerRender(filled_urne_f);
			...
			registerRender(ghost_empty_urne);
			...
			registerRender(block_crop_osmium);
